				...
				<div class="reservations '.$extra_class.'">
					<div class="form">
						<form method="post" action="">
							...
							<div class="clearfix">
								<div class="fdName">	
									<label>'.__('Nome','adora').'</label>
									<input class="name" type="text" name="name" value="" />
								</div>
								<div class="phone">	
									<label>'.__('Fone','adora').'</label>
							...
							<div class="clearfix">
								<label>'.__('Detalhes extras','adora').'</label>
							...
							<div class="clearfix">';
									...
									if ($theme_color=='light'){
										...
										echo '<a href="#"  class="btReserve btSubmit ctButton">'.__('Agendar!','adora').'</a>';
									}
									
							echo '
								<a href="#"  class="btReserve btCancel ctButton">'.__('Fechar','adora').'</a>
							</div>
						</form>
					</div>	
					<div class="success">
						<h2>';
						echo get_option('ermad_reservations_confirmation', __('Obrigado!', 'adora'));
						echo'  
						</h2>
					</div>			
				</div>';
