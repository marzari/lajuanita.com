...
<body>
	...
	<div id="notice-wrapper">
		<div id="notice" class="clearfix">
			<div class="all-medium clearfix">
				...
				<div class="double">
					...
					<div class="newsletter">
						<div>
							<input type="text" value="<?php echo __('Entre com o seu endereço de e-mail') ?>" /> <a href="#"><?php echo __('Submit','adora'); ?></a>
						</div>
					</div>
				</div>
			...
			<div class="bar" >
				<a href="#" class="touch down"> <?php echo __('Puxe!', 'adora'); ?> </a>		
